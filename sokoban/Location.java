...
public class Location {
	...
	/**
	 * Compares this location to another location for equality. Two locations
	 * are equal if and only if they are {@code Location} objects having equal
	 * coordinates.
	 * 
	 * @param obj the object to test for equality
	 * @return true if this location has the same coordinates as the other
	...
	/**
	 * Returns a string representation for this location. The returned string is
	 * the x-coordinate of this location inside a pair of square brackets
	 * followed by the the x-coordinate of this location inside a pair of square
	 * brackets. For example, the location with coordinates (-5, 10) has a
	 * string representation equal to {@code "[-5][10]"}.
	 * 
